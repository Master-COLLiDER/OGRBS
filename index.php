...
<body>
    ...
    <div class="container">
        <div class="navbar-header"><a href="index.php" class="navbar-brand navbar-link"><i class="glyphicon glyphicon-fire text-info"></i>Online Gas Booking System</a>
...
<!--
				...
				<div class="row" id='box'>
					<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="col-md-9">
								<h4>Before connecting, check for LPG leakage</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<h4>Close the regulator knob once you finish cooking</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<h4>Always keep the cylinder vertical, upright during usage and storage</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<h4>Always install LPG pipeline above ground level</h4>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="col-md-9">
								<h4>Don’t place cylinders in closed areas.</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<h4>Do not use any flammable objects near or over the burner</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<h4>Do not switch on or off any lights or electrical equipment, smoke or use naked flames incase of leakage</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<h4>Do not roll the cylinder</h4>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<h4>Never store LPG in basement, cellar, elevated platforms</h4>
							</div>
						</div>
					</div>
				</div>
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h5>MCA 5th Semester Project</h5></div>
			</div>
        </div>
    </footer>
